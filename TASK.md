...
- [x] **TASK-010**: Написати модульні тести та запустити їх паралельно (`tests/`, 20 тестів пройдено).
- [x] **TASK-011**: Оновити документацію `README.md`, `CHANGELOG.md`, `WALKTHROUGH.md`.
