...
- [x] **TASK-012**: Написати модульні тести та запустити їх паралельно (`tests/`, 22 тести пройдено).
- [x] **TASK-013**: Оновити документацію `README.md`, `CHANGELOG.md`, `WALKTHROUGH.md`.
